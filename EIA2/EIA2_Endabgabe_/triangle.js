...
var PaintIt;
(function (PaintIt) {
    class Triangle extends PaintIt.Figure {
        ...
        draw() {
            ...
            PaintIt.crc2.moveTo(0, -25 * this.size);
            PaintIt.crc2.lineTo(-30 * this.size, 25 * this.size);
            PaintIt.crc2.lineTo(30 * this.size, 25 * this.size);
            PaintIt.crc2.lineTo(0, -25 * this.size);
