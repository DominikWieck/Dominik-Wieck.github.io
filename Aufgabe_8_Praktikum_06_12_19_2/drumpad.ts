var myBeat: string [] = ["kick.mp3", "kick.mp3","kick.mp3", "snare.mp3", "hihat.mp3","hihat.mp3", "kick.mp3","hihat.mp3","snare.mp3", "not_even_close.mp3"];
...
var meinButton: HTMLElement = document.querySelector("#play");
